...
const MinimalSelect = ({
  ...
  return (
    <div className="flex flex-col gap-1.5 my-2" ref={dropdownRef}>
      {label && (
      ...
      <div className="relative">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-3 bg-white border border-slate-200/80 rounded-xl text-slate-800 text-sm font-medium shadow-sm hover:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
        >
    ...
    <main className="min-h-screen bg-slate-50/50 pb-20">
      {loading && (
        <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-slate-50/40 backdrop-blur-[24px] transition-all duration-1000 ease-in-out">
          <div className="relative bg-white p-10 rounded-[48px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] border border-white/60 flex flex-col items-center max-w-sm w-[90%] space-y-10">
            <div className="relative flex items-center justify-center size-24 rounded-full bg-white shadow-sm border border-slate-100">
              ...
              <img src="/assets/icons/logo1.svg" className="size-10 drop-shadow-sm" alt="AI" />
            </div>
      ...
      <div>
        ...
        <section className="mt-6 max-w-4xl mx-auto px-4">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {selectItems.map((itemKey) => (
                <MinimalSelect
                  ...
                  value={formData[itemKey] as string}
              ...
              <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-sm space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-mono font-medium text-slate-700 mt-0.5">{formData.country || "Universal"}</p>
                  </div>
                  <div>
            ...
            {/* Error Notification */}
            {error && (
              <div className="p-4 bg-red-50 border border-red-100 text-red-600 rounded-xl text-xs font-medium flex items-center justify-between">
                <span>{error}</span>
