  ...
  createRoutesFromElements(
    <>
      ...
      <Route path="/Home" element={<UserLayout />} loader={UserClientLoader}>
        ...
        // AI Strategist and My Itinerary are the only two routes that have both loader and action because they both need to fetch data and also handle form submissions or interactions that modify data. The other routes either just display data (like UserDashboard) or handle simple actions (like Logout) that don't require pre-fetching data in the same way.
