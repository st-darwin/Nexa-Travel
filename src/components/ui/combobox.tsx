...
// Replace the complex import with this simple styled version
const Button = ({ children, ...props }: any) => (
  <button 
    {...props} 
    className="w-full flex items-center justify-between bg-white/[0.03] border border-white/[0.08] rounded-2xl p-4 text-white"
  >
    {children}
  </button>
);
